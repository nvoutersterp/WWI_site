...
<main>
    ...
    if (isset($_POST['search'])) {
        ...
        $inputq = $_POST['input'];
        $query1 = mysqli_query($conn, "select  stockitems where stockitemid in (select StockItemID from stockitemstockgroups where StockGroupID in (select StockGroupID from stockgroups where StockGroupName = '$inputq'))") or die('Geen overeenkomst');
    }
