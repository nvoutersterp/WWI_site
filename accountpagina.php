...
?>
    ...
    if (isset($_POST['submitProfiel'])) {
        ...
        if (!empty($_POST['gender'])) {
            ...
            print("Geslacht is gewijzigd naar: $nieuwGeslacht");
            print('</br>');
        }
        if (!empty($_POST['geboortedatum'])) {
            ...
            print("Geboortedatum is gewijzigd naar: $nieuweGeboortedatum");
            print('</br>');
        }
            ...
            <div class="card-body">
                ...
                <form method="post" action="accountpagina.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input type="radio" name="gender"
                                   value="man" <?php if (isset($gender) and $gender == 'man') {
                                print ('checked');
                            } ?>> Man
                            <input type="radio" name="gender"
                                   value="female" <?php if (isset($gender) and $gender == 'female') {
                                print ('checked');
                            } ?>> vrouw
                            <input type="radio" name="gender"
                                   value="other" <?php if (isset($gender) and $gender == 'other') {
                                print ('checked');
                            } ?>> Anders<br>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="birthday" type="date" name="geboortedatum"
                                   value="<?php print("$geboortedatum") ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="email" name="email" placeholder="<?php print("$email"); ?>"
                                   ...
                                   title="Geef a.u.b. een geldige email op">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="name" name="telefoonmummer" placeholder="<?php print("$telefoonnummer"); ?>"
                                   class="form-control here" type="text" pattern="[0-9.+]{,12}"
                                   title="geef een geldig telefoonnummer op (zonder '-').">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input id="postcode" name="postcode" placeholder="<?php print("$postcode"); ?>"
                                   class="form-control here" type="text" pattern="[0-9]{4}[A-Z]{2}$"
                                   title="geef een geldig postcode op in de vorm: 1234AB">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="offset-4 col-8">
                            <button name="submitProfiel" type="submit" class="btn btn-primary">Update mijn profiel
                            </button>
                        </div>
                    </div>
                </form>
                <form method="post" action="accountpagina.php">
                    ...
                    <div class="form-group row">
                        <div class="offset-4 col-8">
                            <button name="submitnieuwWW" type="submit" class="btn btn-primary">Verstuur link naar
                                e-mail
                            </button>
                        </div>
                    </div>
    ...
    if (isset($_POST['submitnieuwWW'])) {
        ...
        $htmlContent = '
                                    <html> 
                                    <head> 
                                        <title>Wijzig uw wachtwoord! </title> 
                                    </head> 
                                    <body> 
                                        <h1>Klik op wachtwoord wijzigen voor uw WWI-account.</h1> 
                                           <table cellspacing="0" style="border: 2px dashed #0b7dda; width: 100%;"> 
                                                ...
                                                <tr> 
                                                    <th></th><td><a href=\'http://localhost/WWI_site/wachtwoordwijzigen.php?Recovercode='.$Recovercode.'\'> Wachtwoord wijzigen</a></td> 
                                                </tr>
                                            </table> 
                                    </body> 
                                    </html>';
        ...
        $updaterecovercode = $conn -> query("UPDATE client SET RecoverCode = '$Recovercode' WHERE clientID = '$useringelogd' LIMIT 1");
    }
